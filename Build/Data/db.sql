...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `fe_users` VALUES (1,3,1717180006,1717089603,0,0,0,0,'','0',1718314976,'jondoe','$argon2i$v=19$m=65536,t=16,p=1$Q05aeEtUM29EYll3Y0s3Vw$pWaw11UNerbj4hppKdd3AMN7onwdHBIsp2yRBlJVA84','1','','','','','','','','',NULL,'','','','','','','0','',1717617044,NULL,'','');
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `tx_oauth2server_domain_model_client` VALUES (1,'',2,1718228584,1716752971,0,0,0,0,0,'fc17757d-aa0c-481d-96d7-c2504ce7199f','Test','$argon2i$v=19$m=65536,t=16,p=1$YjhoVmxWNjh2empmeHJOVw$nxnFryba8fO/njcLeOUZwmhyLRzl7UR8/AAyao+MIYQ','authorization_code','https://oauthdebugger.com/debug\r\nhttps://oauthdebugger.com/debug',1,0,'');
